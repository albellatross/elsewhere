import imgImage1 from "figma:asset/b43e4349c17fdbe831f6494be9306b7192c38029.png";
import imgCard02 from "figma:asset/036f0ee5fba18ff822e6c272fcc37bfe0bffbb5c.png";

export default function Card() {
  return (
    <div className="bg-[#ececff] content-stretch flex flex-col items-start justify-between pb-[45px] pt-[25px] px-[25px] relative rounded-[24px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.14),0px_0px_2px_0px_rgba(0,0,0,0.12)] size-full" data-name="Card2">
      <div className="content-stretch flex flex-col gap-[38px] items-start relative shrink-0 w-full">
            ...
            <div className="flex-none rotate-[180deg] scale-y-[-100%]">
              <div className="relative rounded-[24px] size-[300px]" data-name="card 02">
                <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[24px]">
                  <img alt="" className="absolute h-[150%] left-0 max-w-none top-[-2.07%] w-full" src={imgCard02} />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex items-center justify-center min-w-full relative shrink-0 w-[min-content]">
          <div className="flex-none rotate-[180deg] scale-y-[-100%] w-full">
            <p className="font-['Alexandria:Regular',sans-serif] font-normal leading-[normal] relative text-[#050505] text-[14px] w-full">LinkedIn · Personal brand</p>
          </div>
        </div>
      </div>
    </div>
